...
///////////////////////////////////////////////////////////////////////////////
/// @brief Print ur_kernel_set_launch_attribute_exp_params_t struct
/// @returns
///     - ::UR_RESULT_SUCCESS
///     - ::UR_RESULT_ERROR_INVALID_SIZE
///         - `buff_size < out_size`
UR_APIEXPORT ur_result_t UR_APICALL urPrintKernelSetLaunchAttributeExpParams(const struct ur_kernel_set_launch_attribute_exp_params_t *params, char *buffer, const size_t buff_size, size_t *out_size);
